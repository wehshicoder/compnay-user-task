            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('companies.update',['company'=>$company->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row pt-2">
                            <label for="logo_url" class="col-md-4 col-form-label text-md-right">{{ __('Company Logo') }}</label>

                            <div class="col-md-6">
                                <img src="{{asset('/storage/'.$company->logo_url)}}" alt="logo" width="100px" height="150px">
                                <input id="logo_url" type="file" class="form-control @error('logo_url') is-invalid @enderror" name="logo_url" value="{{ old('logo_url') }}" required autocomplete="logo_url">
